...
from kauecpm import CPMnoelcpm

__CHANNEL_USERNAME__ = "@snt.k_aue"
__GROUP_USERNAME__   = "74988061198"
...
def banner(console):
    ...
    brand_name =  "ATENCAO PARA USAR A FERRAMENTA E NECESSARIO ADICIONAR CREDITOS COM O ADM KAUE VENDAS."
    colors = [
